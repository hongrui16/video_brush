...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        ## support upsample residual
        if up_block_additional_residuals is not None:
            for i, up_block_additional_residual in enumerate(up_block_additional_residuals):
                if up_block_additional_residual.dim() == 4:
                    up_block_additional_residual = up_block_additional_residual.unsqueeze(2)
                sample = sample + up_block_additional_residual
