...
from network.models.embedding import TextTimeEmbedding, TextImageTimeEmbedding
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            for _ in range(layers_per_block):
                brushnet_block = InflatedConv3d(output_channel, output_channel, kernel_size=1)
                brushnet_block = zero_module(brushnet_block)
                self.brushnet_down_blocks.append(brushnet_block)
        ...
        brushnet_block = InflatedConv3d(mid_block_channel, mid_block_channel, kernel_size=1)
        brushnet_block = zero_module(brushnet_block)
