...
class Attention(nn.Module):
    def __init__(self, query_dim, dim_head, heads, out_bias=False):
        super(Attention, self).__init__()
        self.heads = heads
        self.scale = dim_head ** -0.5

        self.to_qkv = nn.Linear(query_dim, dim_head * heads * 3, bias=False)
        self.to_out = nn.Linear(dim_head * heads, query_dim, bias=out_bias)
