...
from network.models.unet import UNet3DConditionModel
from network.models.sparse_controlnet import SparseControlNetModel
from network.models.vbrushnet import VBrushUNet3DConditionModel 
from network.models.brushnet import BrushNetModel
...
class VBrushPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        vbrushnet: Union[VBrushUNet3DConditionModel,BrushNetModel] = None,
        ...
        self.use_vbrushnet = vbrushnet is not None
    ...
    def __call__(
        ...
        **kwargs,
        ...
        conditioning_latents = torch.concat([latents,mask],1)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if self.use_vbrushnet:
                    # predict the noise residual
                    down_block_additional_residuals, mid_block_additional_residual, up_block_additional_residuals = self.vbrushnet(
                    latent_model_input,
                    t,
